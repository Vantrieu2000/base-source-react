...
const ActiveAccount = lazy(
  () => import('./pages/passport/active/ActiveSuccess')
);
const RegisterSuccess = lazy(
  () => import('./pages/passport/register/RegisterSuccess')
);
const ForgotPasswordNoitice = lazy(
  () => import('./pages/passport/forgot-password/ForgotPassNoitice')
);
const ResetPassword = lazy(
  () => import('./pages/passport/forgot-password/ResetPassword')
);
