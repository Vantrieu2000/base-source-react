...
import Icon, { EyeOutlined, IdcardOutlined, LockOutlined } from '@ant-design/icons';
  ...
  return (
    <div className="passport-content">
      ...
      >
        ...
        <Form.Item>
          <CustomSelect options={COUNTRY_LANG.map((item) => ({
            label: item.label,
            value: item.value,
          }))} placeholder={intl.formatMessage({ id: 'pages.select.language.placeholder' })}></CustomSelect>
        </Form.Item>
        <Form.Item name="id" rules={ValidateLibrary(intl).name}>
          <CustomInput
            ...
            placeholder={intl.formatMessage({ id: 'pages.login.id.placeholder' })}
